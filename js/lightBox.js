...
const createLightboxSkeleton = () => {
    ...
    const btnWrapLeft = document.createElement("div");
    const btnWrapRight = document.createElement("div");
    ...
    btnWrapLeft.classList.add("btnWrapRight-prev");
    btnWrapRight.classList.add("btnWrapLeft-next");

    swiperPagination.classList.add("swiper-pagination");



    btnWrapLeft.appendChild(swiperBtnPrev);
    btnWrapRight.appendChild(swiperBtnNext);

    // Append created divs
    lightboxContainer.appendChild(lightboxClose);
    swiperContainer.appendChild(swiperWrapper);
    swiperContainer.appendChild(btnWrapRight);
    swiperContainer.appendChild(btnWrapLeft);
    ...
    lightboxImages.forEach(function (el, index) {
        ...
        function imageClick() {
            ...
            swiper = new Swiper(".c-lightbox .swiper-container", {
                ...
                watchOverflow: true,
                navigation: {
                    nextEl: ".btnWrapLeft-next",
                    prevEl: ".btnWrapRight-prev"
                },
                pagination: false,
                zoom: true,
                fadeEffect: {
